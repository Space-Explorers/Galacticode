...
const challenges = [
  ...
  },
  {
    ...
    prompt: `Write a function, nicknameGenerator that takes a string name as an argument and returns the first 3 or 4 letters as that name's nickname! If the 3rd letter is a vowel, return the first 4 letters.`,
    solution:
  ...
  },
  {
    id: 8,
    name: 'My Join',
    prompt: `Write the function myJoin that mirrors the behavior of JavaScript's .join() array method.
  ...
  },
  {
    id: 9,
    name: 'Is Palindrome',
    prompt: `A palindrome is a word that is spelled the same forward and backward. For example, "LEVEL", "RACECAR", and "KAYAK" are all palindromes, while "MOTOR", "RUDDER", and "DOGGED" are not palidromes.
  ...
  },
  {
    id: 10,
    name: 'Demo',
    prompt: `Write a function that returns the argument passed into it.`,
